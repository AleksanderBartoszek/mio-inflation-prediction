...
def main():
    ...
    input_data = data[['inflacja r/r', 'stopa bezrobocia', 'PKB r/r kwartalnie', 'podaż pieniądza M1 (mld zł)',
    ...
    history = model.fit(normalizated_data, inflation, epochs=400)

    print(history.history.keys())
    # Zapisanie loss i accuracy do pliku
    with open('../data/loss.txt', 'w') as f:
